...
export default function Home() {
  const data = [
    {
      img: `${process.env.NEXT_PUBLIC_IMAGES_PATH + '/images/cards/card1.avif'}`,
    ...
    {
      img: `${process.env.NEXT_PUBLIC_IMAGES_PATH + '/images/cards/card2.avif'}`,
    ...
    {
      img: `${process.env.NEXT_PUBLIC_IMAGES_PATH + '/images/cards/card3.avif'}`,
    ...
    {
      img: `${process.env.NEXT_PUBLIC_IMAGES_PATH + '/images/cards/card4.avif'}`,
